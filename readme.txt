...
* **New**: Added option to flag tickets for attention. Flagged tickets are highlighted by a flag icon
* **New**: Added option to agent user profiles allowing selection of where replies are loaded on ticket screen. Before or after reply field
