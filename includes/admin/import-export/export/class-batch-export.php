 ...
 * Batch Export Class
 *
 * This is the base class for all batch export methods. Each data export type (customers, tickets, etc) extend this class
 *
 * @package     KBS
...
/**
 * KBS_Batch_Export Class
 *
 * @since	1.1
 */
class KBS_Batch_Export extends KBS_Export {
	...
	public function __construct( $_step = 1 ) {
		...
		$this->filetype   = '.csv';
		$this->filename   = 'kbs-' . $this->export_type . $this->filetype;
