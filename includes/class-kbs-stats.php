...
class KBS_Stats {
	...
	/**
	 * Modifies the WHERE flag for ticket counts.
	 *
	 * @access	public
	 * @since	1.0
	 * @return	string
	...
	/**
	 * Modifies the WHERE flag for reply counts.
	 *
	 * @access	public
	 * @since	1.2
	 * @return	string
	 */
	public function count_replies_where( $where = '' ) {
		// Only get replies in our date range
	...
	/**
	 * Modifies the WHERE flag for KBS replies queries
	 *
	 * @access	public
	 * @since	1.2
	 * @return	string
	 */
	public function replies_where( $where = '' ) {
	...
	/**
	 * Modifies the WHERE flag for article counts.
	 *
	 * @access	public
	 * @since	1.0
	 * @return	string
	 */
	public function count_articles_where( $where = '' ) {
		// Only get articles in our date range
		...
		return $where;
	} // count_articles_where

	/**
	 * Modifies the WHERE flag for KBS article queries
	 *
	 * @access	public
	 * @since	1.0
	 * @return	string
	 */
	public function articles_where( $where = '' ) {
